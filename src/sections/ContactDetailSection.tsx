// sections/ContactDetailSection.tsx
...
const ContactDetailSection: React.FC<ContactDetailSectionProps> = ({
  ...
  const missionCards = [
    {
      ...
      title: 'Head Office',
      description: '18 Mississippi Street, Maitama, Abuja, Nigeria',
    ...
    },
    {
      ...
      description: 'info@iakenergygroup.com',
      titleColor: 'text-blue-600',
      descriptionClass: 'text-red-500 underline '
    },
    {
      id: 'sustainability-commitment',
      iconSrc: leafWhite,
      title: 'Partnerships',
      description: 'partner@iakenergygroup.com',
      titleColor: 'text-blue-600',
      descriptionClass: 'text-red-500 underline '
    },
    {
      ...
      iconSrc: coinWhite,
      title: 'Careers',
      description: 'careers@iakenergygroup.com',
      titleColor: 'text-blue-600',
      descriptionClass: 'text-red-500 underline '
    }
  ];
  ...
  return (
    <section className={`pb-16 bg-gray-50 ${className}`}>
